#Apuntes primera clase de Introduccion a la programacion.
...
#¿Por que combinarlos?
#Porque input siempre devuelve texto, entonces si quieres hacer operaciones matemáticas necesitas convertirlo:
